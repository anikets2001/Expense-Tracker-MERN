  ...
  return (
    <div className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-56 bg-white dark:bg-[#1a2e1e] rounded-lg shadow-lg border border-[#dbe6df] dark:border-[#2a3a2e] overflow-hidden z-50 max-w-[calc(100vw-2rem)]">
      ...
      <div className="py-1">
        ...
        <button type="button" onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-500 hover:bg-[#f0f4f2] dark:hover:bg-[#102216] transition-colors">
