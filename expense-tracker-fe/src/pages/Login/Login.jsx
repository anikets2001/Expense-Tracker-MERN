          ...
          <section className="bg-white dark:bg-black border border-[#dbe6df] dark:border-[#2a3a2e] p-8 md:p-10 rounded-[34px] lg:rounded-tl-none lg:rounded-bl-none min-h-[680px] flex flex-col">
            <div className="mb-8">
              ...
              <p className="mt-3 text-sm text-[#6b7280] dark:text-slate-400 max-w-md">
                Access your personal expense dashboard and stay on top of every transaction.
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="email" className="block text-sm font-semibold text-[#334155] dark:text-slate-300 mb-2">
                  Email address
                </label>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="text-sm font-semibold text-[#334155] dark:text-slate-300">
                    Password
                  </label>
              ...
              <button
                type="submit"
                className="w-full rounded-2xl bg-primary text-black h-12 font-semibold text-base shadow-lg shadow-primary/20 hover:brightness-95 transition-all flex items-center justify-center gap-2"
              >
                Continue
            ...
            <div className="mt-auto pt-8 text-center text-sm text-slate-500 dark:text-slate-400">
              ...
              <Link to="/signup" className="font-semibold text-primary ml-1 hover:underline">
                Sign up
              </Link>
            </div>
          </section>
